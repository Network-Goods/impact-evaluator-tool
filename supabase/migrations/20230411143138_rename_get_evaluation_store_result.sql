drop function if exists "public"."get_evaluation_result_store"(evaluation_id uuid);
set check_function_bodies = off;
CREATE OR REPLACE FUNCTION public.get_evaluation_result_store(evaluation_id uuid)
 RETURNS json
 LANGUAGE plpgsql
AS $function$
	declare _votes json;
