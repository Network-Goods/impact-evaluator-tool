...
export default function AddGithubModal({
  handleClose,
  link,
  submission,
  open,
    ...
    >
      ...
      >
        <div className="flex justify-between items-center text-offblack">
          <h1 className="text-[28px] text-blue-alt font-semibold">Add Github Repo</h1>
        ...
        <div>
          ...
          <input
            ...
            value={link ? linkState || "" : newInputs.github_link || ""}
